...
public class UploadTasks extends AppCompatActivity implements View.OnClickListener{
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    if (downloadUri != null) {
                        ...
                        Upload upload = new Upload(editTextFilename.getText().toString(), photoStringLink);
